...
# Test with mocked Kimi-Audio imports - fixed import paths
@patch('transformers.AutoProcessor', create=True)
...
class TestKimiAudioProcessor:
    ...
    def test_initialization(self, mock_torch, mock_model_class, mock_processor_class):
    ...
    def test_transcribe_audio(self, mock_torch, mock_model_class, mock_processor_class):
    ...
    def test_analyze_audio_content(self, mock_torch, mock_model_class, mock_processor_class):
    ...
    def test_detect_keywords(self, mock_torch, mock_model_class, mock_processor_class):
    ...
    def test_generate_audio_caption(self, mock_torch, mock_model_class, mock_processor_class):
